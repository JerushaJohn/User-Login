...
function Register(props) {
   ...
   <p style={{marginTop:"20px"}}>Already have account? </p> <br/>
   <Link to="/login" style={{position:"relative",right:"190px" , top:"20px",textDecoration:"none"}}>Login</Link>
        ...
        <div className="col-3  registration-form-container-2">
            <img src="https://thumbs.dreamstime.com/b/registration-online-membership-network-internet-business-technology-concept-104512007.jpg" />
           </div>
